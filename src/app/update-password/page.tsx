            ...
            <form onSubmit={handleUpdatePassword} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#3d1010] border border-white/10 rounded-lg px-4 py-3 text-sm text-white focus:border-[#993333] focus:ring-1 focus:ring-[#993333] outline-none transition-all"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#993333] hover:bg-[#7a2929] active:scale-[0.98] text-white rounded-lg py-3 font-semibold text-sm transition-all shadow-lg hover:shadow-[#993333]/20 flex items-center justify-center gap-2 disabled:opacity-50"
              >
