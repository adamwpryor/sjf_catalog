  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300 font-sans">
      ...
      <div className="relative rounded-3xl overflow-hidden glass-panel p-8 md:p-12 border border-white/5 shadow-2xl">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#993333]/10 rounded-full blur-[100px] -z-10 animate-pulse"></div>

        <div className="max-w-3xl space-y-6">
          <h2 className="text-4xl md:text-5xl font-extrabold serif-title text-white leading-tight">
            Academic Ingestion & <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#993333] via-rose-400 to-[#FFCC33]">
          ...
          <div className="pt-4 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs md:text-sm font-semibold uppercase tracking-widest text-[#FFCC33] font-serif-title">
            <span className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#993333] shadow-glow"></span>
              Browse
            </span>
            <span className="flex items-center gap-2">
      ...
      <div className="glass-panel rounded-3xl p-6 md:p-8 border border-white/5 bg-[#521a1a]/50">
        <h3 className="text-xl md:text-2xl font-extrabold text-white serif-title mb-2 flex items-center gap-2">
          <span className="w-2.5 h-2.5 rounded-full bg-[#993333]"></span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-5 rounded-2xl bg-white/5 border border-white/5 hover:border-[#993333]/40 hover:bg-[#993333]/5 transition-all duration-300">
            ...
            <ul className="space-y-2">
              ...
              >
                <svg className="w-4 h-4 text-[#FFCC33] group-hover/item:text-white transition-colors mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
          ...
          <div className="p-5 rounded-2xl bg-white/5 border border-white/5 hover:border-[#993333]/40 hover:bg-[#993333]/5 transition-all duration-300">
            ...
            <ul className="space-y-2">
              ...
              <li
                ...
                className="group/item flex items-start gap-2.5 p-2 rounded-lg hover:bg-white/5 transition-all cursor-pointer text-slate-300 hover:text-white"
              >
                <svg className="w-4 h-4 text-[#FFCC33] group-hover/item:text-white transition-colors mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                <span className="text-xs md:text-sm font-medium">
