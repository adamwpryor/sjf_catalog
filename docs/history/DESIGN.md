...
as generic SaaS and never as its legacy-client ancestor. Everything here derives from the
...
### 2.5 Don'ts
- ❌ No legacy maroon/`#999999`, slate-only branding, or the old dark-maroon field as *the* brand.
  (Note: [login/page.tsx](../../src/app/login/page.tsx) has been verified clean of legacy hardcoded colors.)
...
tracked against legacy-client upstream — style them freely here.
